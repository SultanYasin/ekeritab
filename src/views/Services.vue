  ...
  <section id="services">
    <div class="services container">
      <div class="service-top">
        ...
        <h2>Systemutveckling med fokus på Java</h2>
        <p>
          Vi arbetar i projekt som kräver ledande färdigheter inom
          mjukvaruutveckling
        </p>
      </div>
...
#services .service-item .title-container {
  padding-left: 10px; /* Add padding to adjust the space between the image and h2 */
}
